package com.rackluxury.rollsroyce.youtube;
...
public class PlaylistCardAdapter extends RecyclerView.Adapter<PlaylistCardAdapter.ViewHolder> {
    ...
    private final com.rackluxury.rollsroyce.youtube.YouTubeRecyclerViewFragment.LastItemReachedListener mListener;
    ...
    public PlaylistCardAdapter(PlaylistVideos playlistVideos, com.rackluxury.rollsroyce.youtube.YouTubeRecyclerViewFragment.LastItemReachedListener lastItemReachedListener) {
